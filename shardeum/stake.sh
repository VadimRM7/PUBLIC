...
# Удаление существующей tmux-сессии (если есть)
if tmux has-session -t $SESSION_NAME 2>/dev/null; then
    tmux kill-session -t $SESSION_NAME
fi

# Создание новой tmux-сессии и запуск стейкинга
...
echo -e "\033[1;34mПроцесс стейкинга запущен в tmux сессии '$SESSION_NAME'.\033[0m"
echo -e "\033[1;34mЧтобы присоединиться к сессии, выполните:\033[0m"
